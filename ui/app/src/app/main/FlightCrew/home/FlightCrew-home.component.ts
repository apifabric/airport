...
@Component({
  selector: 'FlightCrew-home',
  templateUrl: './FlightCrew-home.component.html',
  styleUrls: ['./FlightCrew-home.component.scss']
})
export class FlightCrewHomeComponent implements AfterViewInit {
